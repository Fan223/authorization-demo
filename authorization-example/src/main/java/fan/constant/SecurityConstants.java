...
public class SecurityConstants {
     ...
     * 授权确认页面地址
     */
    public static final String LOGIN_PAGE_URI = "http://172.16.63.132:5173/login";

    /**
     * 授权确认页面地址
     */
    public static final String DEVICE_ACTIVATED_URI = "http://172.16.63.132:5173/activated";

    /**
     * 授权确认页面地址
     */
    public static final String DEVICE_ACTIVATE_URI = "http://172.16.63.132:5173/activate";

    /**
     * 授权确认页面地址
     */
    public static final String CONSENT_PAGE_URI = "http://172.16.63.132:5173/consent";
