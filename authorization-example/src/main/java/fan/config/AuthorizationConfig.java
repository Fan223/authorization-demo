...
import fan.authorization.DeviceClientAuthenticationConverter;
import fan.authorization.DeviceClientAuthenticationProvider;
...
//        http.addFilterBefore(new CaptchaAuthenticationFilter("/login"), UsernamePasswordAuthenticationFilter.class);
    ...
    public RegisteredClientRepository registeredClientRepository(JdbcTemplate jdbcTemplate, PasswordEncoder passwordEncoder) {
        ...
        RegisteredClient registeredClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .redirectUri("http://172.16.63.132:5173/OAuth2Redirect")
        ...
        RegisteredClient pkceClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .authorizationGrantType(AuthorizationGrantType.AUTHORIZATION_CODE)
                .authorizationGrantType(AuthorizationGrantType.REFRESH_TOKEN)
                // 授权码模式回调地址，oauth2.1已改为精准匹配，不能只设置域名，并且屏蔽了localhost，本机使用172.16.63.132访问
                .redirectUri("http://172.16.63.132:5173/PkceRedirect")
                .redirectUri("http://172.16.63.132:8080/login/oauth2/code/messaging-client-oidc")
    ...
    public AuthorizationServerSettings authorizationServerSettings() {
        return AuthorizationServerSettings.builder()
                 ...
                 */
                .issuer("http://172.16.63.132:8080")
                .build();
    }
